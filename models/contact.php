...
//super globalnom $_POST proveravamo da li je forma submitovana i da li su polja prazna, pa izbacujemo poruku ako jesu
		if ($post['submit']) {
			if ($post['name'] == '' || $post['title'] == '' || $post['email'] == '' || $post['body'] == '') {
				Messages::setMsg('Please fill in all fields!','error');
				return;
			}
			//trimujemo mejl sa obe strane pre unosa u tabelu i proveravamo validnost unesenog mejla
