...
<div class="login-block">
    ...
    <?php foreach($viewmodel as $com): ?>
        ...
        <textarea name="body"cols="38" rows="4" id="comment"><?php echo $com['comment']; ?></textarea>
        <input type="hidden" name="deleted_c" value="<?php echo $com['id']; ?>">
        <input type="submit" name="deleted_com" class="dugme">
      </form>  
